...
const makeChoice = function (e) {
	...
	.innerHTML = '<img class = "icon" src="image/'+choices[userchoice].toLowerCase()+'_d_g.svg">'
...
const getResult = function () {
	...
	document.querySelector ('.robotchoice')
	.innerHTML = '<img class = "icon" src="image/' + choices[robotchoice].toLowerCase()+'_d_g.svg"></div>';
